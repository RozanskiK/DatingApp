...
import { MembeCard } from '../membe-card/membe-card';
...
@Component({
  ...
  imports: [MembeCard, Paginator, FilterModal],
...
export class MemberList implements OnInit {
  ...
  get displayMassage(): string {
    const defoultParams = new MemberParams();
    ...
    if (
      this.updatedParams.minAge !== defoultParams.minAge ||
      this.updatedParams.maxAge !== defoultParams.maxAge
    ) {
